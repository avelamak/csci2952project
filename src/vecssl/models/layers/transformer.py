...
class Transformer(Module):
    ...
    def forward(
        ...
        # type: (Tensor, Tensor, Optional[Tensor], Optional[Tensor], Optional[Tensor], Optional[Tensor], Optional[Tensor], Optional[Tensor]) -> Tensor
...
class TransformerEncoder(Module):
    ...
    def forward(self, src, memory2=None, mask=None, src_key_padding_mask=None):
        ...
        for mod in self.layers:
            output = mod(
                output, memory2=memory2, src_mask=mask, src_key_padding_mask=src_key_padding_mask
            )
